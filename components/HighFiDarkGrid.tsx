...
export default function HighFiDarkGrid(_props:any)
{
    const items = [
        {
            name: "Home",
            description: "Main home screen",
            filepath: "/hifi_dark_01.svg",

...
export default function HighFidelityGridSS(_props:any)
{
    const items = [
        {
            name: "Home",
            description: "Overview of all systems",
            filepath: "/hifi_11.svg",
